...
// ================ Directly enroll student without payment ================
exports.enrollStudent = async (req, res) => {
    try {
        ...
        console.log("Enrolling student", userId, "in courses:", coursesId);
        ...
        for (const courseId of coursesId) {
            try {
                ...
                if (course.studentsEnrolled.includes(userId)) {
                    ...
                    continue; // Skip this course and proceed to the next
                }

                // Add student to course
                console.log(`Adding student ${userId} to course ${courseId}`);
                ...
                console.log(`Adding course ${courseId} to student ${userId}'s enrolled courses`);
                ...
                console.log(`Successfully enrolled student ${userId} in course ${courseId}`);
            } catch (error) {
